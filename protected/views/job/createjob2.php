   ...
   <div class="col-md-12">
    ...
    <div class="col-md-6">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8">
          <textarea class="form-control" rows="3" style="border-radius: 5px;" id="order_comment" placeholder=""></textarea>
        </div>
      </div>
    </div>
           ...
           <div class="form-group">
            ...
            <div class="col-sm-8">
              <div class="input-group" style="border-radius: 5px;">
                ...
                <input type="text" class="form-control" id="order_price_total" onKeyUp="if(isNaN(this.value)){ alert('ตัวเลขเท่านั้น'); this.value='';}">
              </div>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <div class="input-group date" style="border-radius: 5px;">
                ...
                <input type="text" class="form-control" id="paydate" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask="" value="<?php echo date("d/m/Y");?>">
              </div>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <div class="input-group" style="border-radius: 5px;">
                ...
                <input type="text" class="form-control"  id="paytime" data-inputmask="&quot;mask&quot;: &quot;99:99&quot;" data-mask="" value="<?php echo date(" H:i");?>" >
              </div>
      ...
      // if(document.getElementById("type_search").checked==false){
        ...
        //$("#save").click(function(){
          $("form").submit(function(evt){
           //  evt.preventDefault();
           //  var formData = new FormData($(this)[0]);
           //  formData.append('file', $('#order_file')[0].files[0]);

           //  for (var value of formData.values()) {
           //    alert(value);
           // }
           $('#order_file').fileupload({
            add: function (e, data) {
